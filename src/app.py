...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["natalie@mergington.edu", "eric@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Drama Club": {
        "description": "Develop acting skills and stage productions for school events",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["ava@mergington.edu", "jack@mergington.edu"]
    },
    "Book Club": {
        "description": "Discuss novels, essays, and articles with fellow readers",
